...
FORCED_DRAFT_NUDGE = (
    ...
    "Output ONLY in the following exact structure:\n\n"
    "Problem framing:\n"
    "- <one short bullet, max 20 words>\n\n"
    "Most likely direction:\n"
    "- <one short bullet, max 20 words>\n\n"
    "Concrete DEBUG_STEPS:\n"
    "1. <short step, max 20 words>\n"
    "2. <short step, max 20 words>\n"
    "3. <short step, max 20 words>\n"
    "4. <short step, max 20 words>\n"
    "5. <short step, max 20 words>\n\n"
    "Unknowns:\n"
    "- <up to 3 short bullets, max 20 words each>\n\n"
    "Why this path first:\n"
    "- <one short bullet, max 20 words>\n\n"
    "Rules:\n"
    "- no prose paragraphs\n"
